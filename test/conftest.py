...
def db_setup(db):
    ...
    SelectedQuestion.objects.create(essay_ref=essay_answer_1, issued_exam=issued_exam_1)
    essay_answer_4 = EssayAnswer.objects.get(id=4)
    SelectedQuestion.objects.create(essay_ref=essay_answer_4, issued_exam=issued_exam_1)

    issued_exam_2 = IssuedExam.objects.get(exam_identifier=exam_2)
    essay_answer_2 = EssayAnswer.objects.get(id=2)
    SelectedQuestion.objects.create(essay_ref=essay_answer_2, issued_exam=issued_exam_2)

    # 4.
    username_1, username_2, username_3 = ("user1", "user2", "user3")
    pw = "pw"
    call_command("createuser", username_1, pw, f"{username_1}@sciara.com", group=exam_1)
    call_command("createuser", username_2, pw, f"{username_2}@sciara.com", group=exam_2)
    call_command("createuser", username_3, pw, f"{username_3}@sciara.com", group=exam_3)
